...
namespace WpfApp5
{
    ...
    {
        /// <summary>
        /// Конструктор вызова метода инициализации визуальных компонентов экранной формы
        /// </summary>
        public ConfigurationWindow()
        {
            //Метод инициализации всех визуальных компонентов на форме
            InitializeComponent();
        }
        /// <summary>
        ...
        private void regSet(string ds, string ic)
        {
            ...
            //Создание или открытие в папке CurrentUser папки с названием DBSetAPPConfig
        ...
        /// <summary>
        /// Обработка события по нажатию на кнопку "Получить список БД"
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Метод обработки события по нажатию на кнопку "Подключить"
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Метод по обработке события по нажатию на кнопку "Отмена"
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
